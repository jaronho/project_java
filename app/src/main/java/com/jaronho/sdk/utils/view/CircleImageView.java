...
public class CircleImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mShowFlag && mFlagText != null) {
            ...
            canvas.drawText(mFlagText, getWidth() / 2, (float) ((3 + Math.cos((float) (Math.PI * 5 / 18))) * getHeight() / 4 + mFlagTextBounds.height() / 3), mFlagTextPaint);
        }
    }
    ...
    private void setup() {
        ...
        mSweepGradient = new SweepGradient(getWidth() / 2, getHeight() / 2, new int[] { Color.rgb(255, 255, 255), Color.rgb(1, 209, 255) }, null);
