...
import com.jaronho.sdk.third.elasticity.adapters.IElasticityAdapter;
import com.jaronho.sdk.third.elasticity.adapters.RecyclerViewElasticityAdapter;

import static com.jaronho.sdk.third.elasticity.IElasticityState.*;
...
public abstract class ElasticityBounceEffectBase implements IElasticity, View.OnTouchListener {
    ...
    private final static int KEY_OFFSET_VALUE = 0xF0F0F0;

    protected float getViewOffset(View view) {
        if (view.getTag(KEY_OFFSET_VALUE) != null) {
            return (float) view.getTag(KEY_OFFSET_VALUE);
        }
        return 0;
    }

    protected void setViewOffset(View view, float offset) {
        view.setTag(KEY_OFFSET_VALUE, offset);
    }
